# This is the code for a parameterized PlackettLuce type (Distribution).  I'll
# keep it here for now in case I decide I need it, but the constructors for the
# Vector{Float64} and Vector{Int64} cases for p should work fine.
